...
public class AddNewPersonActivity extends Activity {
	...
	public void onResume() {
		...
		// @ToDo nastavit defaultn� selekt
		// s.setSelection(2);
		// Group selectedGroup = ((Application) getApplication()).selectedGroup;

		/* start tla��tka pro v�b�r fotky z galerie */
		...
		/* konec tla��tka pro v�b�r fotky z galerie */
	...
	private void addImageToGrid(Uri uri) {
		// ToDo tady se nam�sto vlo�en� do pole vlo�� do photoGrid
